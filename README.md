...
| **User Search Engine Queries** | User search queries sent to websites in the Search Engine category, with separate result tables for Google, Bing, Ask.com, Yahoo Search, Yandex, and DuckDuckGo.|[Download](./User%20Search%20Engine%20Queries.json)|
## Prerequisites
